        ...
        <div>
            <div class="flex justify-between sticky top-0">
                ...
                <div>
                    ...
                    <Link :href="route('quizzes.destroy', quizz)" method="DELETE" class="ml-3.5 block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-200 transition duration-150 ease-in-out">
